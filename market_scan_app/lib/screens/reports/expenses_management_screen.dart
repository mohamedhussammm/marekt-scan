...
class _ExpensesManagementScreenState extends State<ExpensesManagementScreen> {
              ...
              ElevatedButton(
                ...
                onPressed: isSubmitting
                    ...
                    : () async {
                        ...
                        final res = await provider.recordPettyExpense(amount, desc, category: _dialogCategory);
  ...
  void _showEditExpenseDialog(PettyExpense expense) {
    ...
    String dialogCategory = expense.category;
    bool isSubmitting = false;
              ...
              child: Column(
                ...
                children: [
                  DropdownButtonFormField<String>(
                    ...
                    onChanged: (val) {
                      if (val != null) {
                        setDialogState(() => dialogCategory = val);
                      }
                    },
                  ),
                  const SizedBox(height: 12),
              ...
              ElevatedButton(
                ...
                onPressed: isSubmitting
                    ...
                    : () async {
                        ...
                        final provider = context.read<AppProvider>();
                        final scaffoldMessenger = ScaffoldMessenger.of(context);
                        final res = await provider.editPettyExpense(expense, amount, desc, dialogCategory);
                        ...
                        if (res['success'] == true) {
                          ...
                          scaffoldMessenger.showSnackBar(
                            SnackBar(
                              content: Text(res['error'] ?? 'فشل تعديل المصروف'),
                              backgroundColor: Colors.redAccent,
                            ),
                          );
                        }
                ...
                child: isSubmitting
                    ...
                    : const Text('حفظ', style: TextStyle(fontFamily: 'Cairo', fontWeight: FontWeight.bold)),
              ),
            ],
          );
        },
  ...
  void _showDeleteConfirmation(PettyExpense expense) {
    showDialog(
      context: context,
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            onPressed: () async {
              ...
              final provider = context.read<AppProvider>();
              final scaffoldMessenger = ScaffoldMessenger.of(context);
              final res = await provider.deletePettyExpense(expense);
              if (!mounted) return;
              if (res['success'] == true) {
                scaffoldMessenger.showSnackBar(
                  const SnackBar(
                ...
                scaffoldMessenger.showSnackBar(
                  SnackBar(
                    content: Text(res['error'] ?? 'فشل حذف المصروف'),
                    backgroundColor: Colors.redAccent,
                  ),
                );
              }
                                            ...
                                            if (item.isOffline) ...[
                                              ...
                                              Container(
                                                ...
                                                child: Row(
                                                  mainAxisSize: MainAxisSize.min,
                                                  children: [
                                                    Icon(Icons.sync_problem, size: 10, color: Colors.amber[800]),
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          Material(
                                            ...
                                            child: InkWell(
                                              borderRadius: BorderRadius.circular(16),
                                              onTap: () => _showEditExpenseDialog(item),
                                              child: Container(
